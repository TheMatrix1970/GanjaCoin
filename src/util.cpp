...
#else
    const char* pszModule = "Ganjaproject";
#endif
    if (pex)
        return strprintf(
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ganjaproject";
#else
    fs::path pathRet;
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ...
               fprintf(ConfFile, "port=11419\n");
               fprintf(ConfFile, "rpcport=11420\n");
