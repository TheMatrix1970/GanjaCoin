...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("v1.0.0.5"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Ganjaproject", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Ganjaproject</b> version", 0));
...
"Copyright \302\251 2018 The GanjaCoin Developers", 0));
