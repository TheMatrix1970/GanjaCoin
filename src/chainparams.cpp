...
public:
	CMainParams() {
        ...
        vAlertPubKey = ParseHex("047d56dfe457804d865745896c8e40b8a56f979e73508851521d043b279301f32139ccc9f1475f3fc661b97138f0b49f65eff4deb025b23862075fadcd3538cc39");
        nDefaultPort = 11419;
        nRPCPort = 11420;
		...
		vout.resize(1);
		vout[0].SetEmpty();
        CTransaction txNew(1, 1526264490, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
        genesis.nTime = 1526264490; //
		genesis.nBits = 520159231;
        genesis.nNonce = 39659;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xbb9207ad6022bf5691f12103d09fa0b7044fdca62fdd897bf0e26e915147b556"));
        assert(hashGenesisBlock == uint256("0x0000ec9d4f2f1b94c0b870aa4fa4d950b5301274451d9d0346d21a18f2e99e5f"));
...
public:
	CTestNetParams() {
		...
		bnProofOfWorkLimit = CBigNum(~uint256(0) >> 16);
        vAlertPubKey = ParseHex("042a4acc614209d425e45c73b11e8f5c2afefdab644689948d74587efbd32bfe8a810ed0532359f42f6a15830137c28d10504056cb64539e5fea5f9ed1dc62aa2b");
		nDefaultPort = 33133;
		nRPCPort = 33155;
		strDataDir = "testnet";
        genesis.nTime = 1526264490; //
		...
		genesis.nBits = 520159231;
        genesis.nNonce = 21007;



        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000dce8b265fbf203ffd5ee0f2e4d222b2bfedaed708890dae219b5ea8a6de3"));
