...
public:
    ...
    void retranslateUi(QWidget *DarksendPage)
    {
        ...
        labelDarksendSyncStatus->setToolTip(QApplication::translate("DarksendPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Ganjaproject network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        denominatedBalanceValue->setText(QApplication::translate("DarksendPage", "0.00 MRJA", 0));
        label_8->setText(QApplication::translate("DarksendPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("DarksendPage", "0 MRJA / 0 Rounds", 0));
