...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 IC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 IC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 IC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 IC"));
